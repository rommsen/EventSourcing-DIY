    ...
    let rec loop eventStore =
      async {
        ...
        | DemoData ->
            ...
            eventStore.Append truck1 [IcecreamSold Vanilla]
            eventStore.Append truck1 [IcecreamSold Vanilla]
            eventStore.Append truck1 [IcecreamSold Strawberry ]
            eventStore.Append truck1 [IcecreamSold Strawberry ; Flavour_empty Strawberry]

            eventStore.Append truck2 [Icecream_Restocked (Vanilla,2)]
            eventStore.Append truck2 [Icecream_Restocked (Strawberry,5)]
            eventStore.Append truck2 [IcecreamSold Vanilla]
            eventStore.Append truck2 [IcecreamSold Strawberry ]
